...
if(bRefresh) {
  ...
  strQuandl = "MULTPL/SP500_DIV_MONTH"
  df.symbols <-
    rbind(
      df.symbols,
      data.frame(
        string.symbol = strQuandl,
        string.source = "QUANDL",
...
```{r treeplot.switch.1, echo=TRUE, fig.width=10, fig.height=6}
...
```{r treeplot.switch, echo=TRUE, fig.width=10, fig.height=11}
...
```{r treeplot.smooth, echo=TRUE, fig.width=10,fig.height=11}
...
```{r plotbackbase, fig.width=7, fig.height=10}
...
```{r SP500Vol_Smoott, echo=TRUE, fig.width = 9, fig.asp = 0.4}
...
```{r OCC.equity.volume, fig.width = 7, fig.asp = 1.1 }
...
```{r OCC.equity.volume.to.market, fig.width = 7, fig.asp = 1.1 }
...
```{r VIXtoGSPCCorr, fig.width = 7, fig.asp = 1.1}
...
```{r rsalesYoYToUNRATE.yoy, echo=TRUE}
datay <- "RSALESAGG_YoY" 
...
```{r plot.CHRISCMEHG1.yoy, echo=TRUE}
...
```{r WRESBALspread, echo=TRUE, fig.width = 9, fig.asp = 0.4}
...
```{r WRESBALspread.GPD, echo=TRUE, fig.width = 9, fig.asp = 0.4}
...
```{r WRESBAL_YoY, echo=TRUE, fig.width = 11, fig.asp = 0.4}
...
```{r ECBASSETS, echo=TRUE, fig.width = 9, fig.asp = 0.4}
...
```{r ECBASSETS.by.GDP, echo=TRUE, fig.width = 9, fig.asp = 0.4}
...
```{r USTotalDebt.by.GDP, fig.width = 7, fig.asp = 1.1}
...
```{r GDPBYCPIAUCSLBYPOPTHM, echo=TRUE}
...
```{r GDPBYCPIAUCSLBYPOPTHM_SmoothDer, echo=TRUE}
...
```{r corplot.commodities, echo=TRUE, fig.width=10,fig.height=10}
...
```{r corplot.gdp, echo=TRUE, fig.width=10,fig.height=10}
...
```{r corplot1, echo=TRUE, fig.width=12,fig.height=12}
# Correlation for the entire data set
