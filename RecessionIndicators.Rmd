...
#
# Reserve exactly one . to separate symbol vs. field (e.g., GSPC.Close,
# GDP.Value).
#
...
# TODO - this needs to be moved to the front of the file so it can be used for 
# all the external data sources.
