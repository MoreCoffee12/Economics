...
df.silverblatt <- data.frame(read_excel('sp-500-eps-est.xlsx', range='QUARTERLY DATA!A6:I138'))
...
df.silverblatt.est <-
  data.frame(read_excel('sp-500-eps-est.xlsx', range = 'ESTIMATES&PEs!A129:J133'))
