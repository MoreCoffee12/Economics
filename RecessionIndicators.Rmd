...
# Document the residual as well
str.symbol.res <- "U3.knn.CCSA.res"
df.data[str.symbol.res] <- df.data$UNRATE - df.data[str.symbol]
...
str.name <- c('U6 from U3','U3 from ICSA', 'U3 from CCSA')
dt.list.start <- c(index(U6RATE[1]), index(ICSA[1]), index(CCSA[1]))
