...
```{r U3_pred_NPPTTL_setup, echo=FALSE}

# The U6 numbers do not have as much historical data as the U3 so valid data for
# fit begins early. I also exluded the Covid 16 mess of data.
...
d.test.resid = (df.test$UNRATE - predict(list.fit.adpwnusnersa, newdata = df.test))
